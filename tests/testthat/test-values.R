describe("values", {
  it("returns a list of values",{
    ...
    d <- data.frame(id = 1:3, a = c("A1", "A3", NA), b = c("B3", NA, "B2"), x = 0)
  ...
  it("returns a tbl of values",{
    ...
    expect_equal(res_df, data.frame(id=1:3, V1 = c(1,0,NA), V2 = c(0,NA,1)))
  })
  ...
  it("returns a data.frame of values",{
    ...
    expect_equal(res, data.frame(id = 1:3, V1 = c(TRUE,FALSE,NA), V2 = c(FALSE,NA,TRUE)))
  })
